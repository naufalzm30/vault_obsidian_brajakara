...
**All routing** → [[06_INDEX (Navigation hub)/Navigation_Map|Navigation_Map]] → folder index → detail file.
...
**WAJIB tanya konfirmasi dulu** sebelum menjalankan command yang bersifat destructive atau modifikasi sistem. Tunggu jawaban user, baru eksekusi.
...
**Keyword mapping:** Lihat `00_INBOX/Daily_Notes/index.md` — comprehensive table keyword → wikilink target untuk projects, infrastructure, profile, dll.
